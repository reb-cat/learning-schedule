...
ALTER TABLE public.assignments 
ADD CONSTRAINT IF NOT EXISTS assignments_task_type_check 
CHECK (task_type IN ('academic', 'administrative', 'quick_review'));
...
CREATE TRIGGER IF NOT EXISTS auto_classify_assignment_trigger
